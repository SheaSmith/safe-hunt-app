...
class TripsPageState extends State<TripsPage> {
  createTrip(Trip planPreset) {
    // do nothing. we just pretend this works!
  }
                      ...
                      child: GestureDetector(
                        child: Column(
                          ...
                          children: <Widget>[
                            Row(children: [
                              Text(
                                dateformat.format(snapshot.data[index].start) +
                                    " until " +
                                    dateformat.format(snapshot.data[index].end),
                                style: TextStyle(
                              ...
                              Text(
                                snapshot.data[index].preset.name,
                                style:
                                    ...
                                    imageUrl:
                                        "https://api.mapbox.com/styles/v1/shea9872/ck1wxatvm05411cpc1vbp99rp/static/path-1+0000FF-1+0000FF-0.5(" +
                                            Uri.encodeComponent(encodePolyline(
                                                snapshot.data[index].preset.points)) +
